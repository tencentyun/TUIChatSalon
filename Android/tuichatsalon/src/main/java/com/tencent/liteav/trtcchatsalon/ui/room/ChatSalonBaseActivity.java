...
import com.tencent.liteav.trtcchatsalon.ui.utils.PermissionHelper;
...
public class ChatSalonBaseActivity extends AppCompatActivity implements ChatSalonAnchorAdapter.OnItemClickListener,
        ...
        mBtnMic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkButtonPermission()) {
                    PermissionHelper.requestPermission(ChatSalonBaseActivity.this,
    ...
    protected void initView() {
        ...
        mAnchorAdapter = new ChatSalonAnchorAdapter(this, mAnchorEntityList,
                new ChatSalonAnchorAdapter.OnItemClickListener() {
            @Override
        ...
        mAudienceAdapter = new ChatSalonAudienceAdapter(this, mAudienceEntityList,
                new ChatSalonAudienceAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(int position) {
