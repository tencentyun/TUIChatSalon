...
public class ChatSalonAnchorActivity extends ChatSalonBaseActivity {
    ...
    public static void createRoom(Context context, String roomName, String userId,
                                  String userName, String userAvatar, String coverUrl, int audioQuality,
                                  boolean needRequest) {
    ...
    private void destroyRoom() {
        ChatSalonRoomManager.getInstance().destroyRoom(mRoomId, new ChatSalonRoomManager.ActionCallback() {
            @Override
            ...
            public void onError(int errorCode, String message) {
                Log.d(TAG, "destroyRoom failed[" + errorCode);
            }
        });
    ...
    private void onTRTCRoomCreateSuccess() {
        ...
        ChatSalonRoomManager.getInstance().createRoom(mRoomId, new ChatSalonRoomManager.ActionCallback() {
            @Override
            public void onSuccess() {
