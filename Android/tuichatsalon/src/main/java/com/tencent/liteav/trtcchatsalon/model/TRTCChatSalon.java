...
public abstract class TRTCChatSalon {
     ...
     *
     * @param delegate 回调接口
     * @note TRTCChatSalon 中的事件，默认是在 Main Thread 中回调给您；如果您需要指定事件回调所在的线程，
     * 可使用 {@link TRTCChatSalon#setDelegateHandler(Handler)}
     */
     ...
     */
    public abstract void login(int sdkAppId, String userId,
                               String userSig, TRTCChatSalonCallback.ActionCallback callback);
     ...
     */
    public abstract void setSelfProfile(String userName,
                                        String avatarURL, TRTCChatSalonCallback.ActionCallback callback);
     ...
     */
    public abstract void createRoom(int roomId, TRTCChatSalonDef.RoomParam roomParam,
    ...
    public abstract void getUserInfoList(List<String> userIdList,
                                         TRTCChatSalonCallback.UserListCallback userListCallback);
