本文档主要介绍如何快速集成实时音视频（TRTC）SDK，运行 TRTC 场景化解决方案，实现语音沙龙。	
## 目录结构
	
```
TUIChatSalon
├─ App              // 语音沙龙主页UI代码以及用到的图片及国际化字符串资源文件夹
├─ Debug            // 工程调试运行所需的关键业务代码文件夹
├─ LoginMock        // 登录UI及业务逻辑代码文件夹
├─ Resources        // 语音沙龙功能所需的图片、国际化字符串资源文件夹
├─ Source           // 语音沙龙核心业务逻辑代码文件夹
...
### 配置工程文件
1. 使用Xcode(11.0及以上)打开源码工程`TUIChatSalonApp.xcworkspace`。
2. 工程内找到`TUIChatSalon/Debug/GenerateTestUserSig.swift`文件 。
...
<img src="https://liteav.sdk.qcloud.com/doc/res/trtc/picture/zh-cn/tuichatsalon_create_room_ios.PNG" width="320"/>
...
<img src="https://liteav.sdk.qcloud.com/doc/res/trtc/picture/zh-cn/tuichatsalon_enter_room_ios.png" width="320"/>

<font color=red>请注意，房间号在用户 A 的房间顶部查看，如下图示：</font>

<img src="https://liteav.sdk.qcloud.com/doc/res/trtc/picture/zh-cn/tuichatsalon_roomid_ios.PNG" width="320"/>
