...
#import "TRTCChatSalonDelegate.h"
#import "TRTCChatSalonDef.h"

NS_ASSUME_NONNULL_BEGIN

@class TXAudioEffectManager;
@interface TRTCChatSalon : NSObject
...
* - parameter callback 操作回调
*/
- (void)leaveSeat:(ActionCallback _Nullable)callback
NS_SWIFT_NAME(leaveSeat(callback:));
