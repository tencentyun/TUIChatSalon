...
protocol ChatSalonMainRootViewDelegate: NSObject {
    func enterRoom(roomId: String)
    func createRoom()
}

class ChatSalonMainRootView: UIView {
    ...
    weak var delegate: ChatSalonMainRootViewDelegate? = nil
...
extension ChatSalonMainRootView {
...
private extension String {
    static let roomNumberText = TRTCChatSalonLocalize("Demo.TRTC.LiveRoom.roomNumber")
    static let enterRoomNumberText = TRTCChatSalonLocalize("Demo.TRTC.LiveRoom.enterRoomNumber")
    static let enterRoomText = TRTCChatSalonLocalize("Demo.TRTC.LiveRoom.enterRoom")
    static let createRoomText = TRTCChatSalonLocalize("Demo.TRTC.LiveRoom.createRoom")
}
